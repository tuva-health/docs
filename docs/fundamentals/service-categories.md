...
![The Tuva Project](/img/service_categories/tuva_service_categories.png)
...
#### Acute Inpatient
For institutional claims, we define acute inpatient as all claim lines with bill_type_codes of 11 or 12, and at least one line on the claim had a room and board revenue code in the following list '0100', '0101', 
