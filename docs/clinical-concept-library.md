...
| coding_system_version   | string    | Version of the coding system used                                                                                                                                                                         |
...
| last_update_note      | string    | Relevant details regarding the nature and reasons for the most recent update.                                                                                                                                                                 |
| code                  | string    | Standardized code that represents the concept, to facilitate searching for clinical concepts by standardized code. Not to be confused with value set codes, this is meant to be synonymous with the concept or, if a synonymous code isn’t available, the closest subsuming code. |
| code_description      | string    | Description for the code in concept_coding_code.                                                                                                                                                                                              |
| coding_system_id      | FK        | Coding system for code in concept_coding_code. Foreign key to coding_systems                                                                                                                                                                  |
