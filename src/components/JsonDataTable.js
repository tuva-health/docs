...
export function JsonDataTable({jsonPath}) {
    ...
    useEffect(() => {
        var fetchData = async () => {
            try {
                var responseMan = await fetch("https://raw.githubusercontent.com/tuva-health/the_tuva_project/package-consolidation/docs/manifest.json");
                var responseCat = await fetch("https://raw.githubusercontent.com/tuva-health/the_tuva_project/package-consolidation/docs/catalog.json");
